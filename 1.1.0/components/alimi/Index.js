...
const JSON_URL =
  "https://ugxtzdljzj.execute-api.ap-northeast-2.amazonaws.com/2020-08-04/covid";
...
export default function Index({ navigation }) {
  ...
  const getLocation = async () => {
    try {
      ...
      const latitude = 37.56667;
      const longitude = 126.97806;
      setisLoading(false);
      const myLocation = {
      ...
      fetch(JSON_URL)
        ...
        .then((cnt) => {
          ...
          setbgColor([
            COLORS[conditions.conditionBgColor],
            COLORS[conditions.conditionBgColor - 1],
          ]);
        });
    } catch (error) {
